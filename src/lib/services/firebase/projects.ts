...
export const OFFICIAL_PROJECTS: Project[] = [
  ...
  {
    id: "kc",
    title: "A Student's Chromebook in Kenya",
  ...
  {
    id: "kc-library",
    title: "A Mobile Library for 3 Schools in Kenya",
    sponsor: "Kenya Connect",
  ...
  {
    id: "stm-palestine",
    title: "A Life-Saving Meal in Palestine",
  ...
  {
    id: "stm-ukraine",
    title: "An Emergency Meal in Ukraine",
    sponsor: "Share the Meal",
  ...
  {
    id: "stm-syria",
    title: "A Meal for Families in Syria",
    sponsor: "Share the Meal",
